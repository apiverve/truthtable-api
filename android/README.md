# Truth Table Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:truthtable-api:1.1.14'
}
```
...
```java
import com.apiverve.truthtable.TruthTableGeneratorAPIClient;
import com.apiverve.truthtable.APIResponse;
import com.apiverve.truthtable.APIException;

// Initialize the client
TruthTableGeneratorAPIClient client = new TruthTableGeneratorAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("expression", "A AND B OR C");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/truthtable](https://docs.apiverve.com/ref/truthtable)
...
- **Documentation:** [https://docs.apiverve.com/ref/truthtable](https://docs.apiverve.com/ref/truthtable)
- **Issues:** [GitHub Issues](https://github.com/apiverve/truthtable-api/issues)
