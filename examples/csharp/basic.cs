...
{
    class TruthTableGeneratorExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/truthtable";

        /// <summary>
        /// Make a GET request to the Truth Table Generator API
        /// </summary>
        static async Task<JsonDocument> CallTruthTableGeneratorAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;expression&quot;] &#x3D; &quot;A AND B OR C&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Truth Table Generator API...\n");

            var result = await CallTruthTableGeneratorAPI();
