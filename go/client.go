...
const (
	baseURL        = "https://api.apiverve.com/v1/truthtable"
	defaultTimeout = 30 * time.Second
)

// Client is the Truth Table Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Truth Table Generator API client.
...
// Execute makes a request to the Truth Table Generator API with typed parameters.
//
