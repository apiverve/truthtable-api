// Package truthtable provides a Go client for the Truth Table Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/truthtable?utm_source=go&utm_medium=readme
package truthtable
...
// Request contains the parameters for the Truth Table Generator API.
//
// Parameters:
//   - expression (required): string - Boolean expression using A-Z variables and operators (AND, OR, NOT, XOR, NAND, NOR)
type Request struct {
...
// ResponseData contains the data returned by the Truth Table Generator API.
type ResponseData struct {
	...
	Rows []RowsItem `json:"rows"`
	AsciiTable string `json:"asciiTable"`
}

// RowsItem represents an item in the Rows array.
type RowsItem struct {
	Inputs InputsData `json:"inputs"`
	Result int `json:"result"`
}

// InputsData represents the inputs object.
