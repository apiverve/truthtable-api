...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/truthtable',
        'Source': 'https://github.com/apiverve/truthtable-api',
        'Bug Tracker': 'https://github.com/apiverve/truthtable-api/issues'
    },
    classifiers=[
